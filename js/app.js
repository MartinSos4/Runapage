const seccionesPagina = new fullpage('#fullpage', {
	...
	anchors: ['inicio', 'productos', 'lugares' , 'contacto'], // Anclas, las usamos para identificar cada seccion y poder acceder a ellas con el menu.
	navigationTooltips: ['Inicio', 'Productos', 'Donde encontrarnos' , 'contacto'], // Tooltips que mostrara por cada boton.
